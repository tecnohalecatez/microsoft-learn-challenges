...
21. Debe eliminar una imagen con la etiqueta dev/nginx:latest de un registro de contenedor de Azure denominado devregistry.
¿Qué segmento de código debería usar?
...
22. Desarrolla una aplicación web hospedada en la característica Web Apps de Microsoft Azure App Service.
...
23. Tiene previsto desarrollar una aplicación web de Azure App Service denominada app1 mediante un contenedor personalizado de Windows.
...
24. Administra las ranuras de implementación de ensayo y producción de una aplicación web de Azure App Service denominada app1.
...
25. Una empresa planea implementar una solución de Microsoft Defender for Cloud.
...
26. Usted crea una rutina por lotes mediante un desencadenador de temporizador en Azure Functions.
...
27. Está desarrollando una aplicación de .NET que incluye varias imágenes de contenedor. La aplicación se implementará en Azure Container Instances (ACI).
...
28. Un grupo de contenedores en Azure Container Instances tiene varios contenedores.
...
29. Está desarrollando una aplicación de tareas en segundo plano de contenedor nativa en la nube.
...
30. Está desarrollando una aplicación web Linux en Azure App Service.
...
31. Administra una base de datos de Azure Cosmos DB denominada database1.
...
32. Administra un contenedor de Azure Cosmos DB denominado container1.
...
33. Tiene una aplicación que escribe datos en Azure Cosmos DB.
...
34. Tiene blobs en Azure Blob Storage. Los blobs almacenan imágenes.
...
35. Debe descargar el contenido del blob en una matriz de bytes mediante una operación que se recupera automáticamente frente a errores transitorios.
